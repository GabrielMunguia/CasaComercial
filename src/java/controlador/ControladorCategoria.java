...
public class ControladorCategoria extends HttpServlet {
 ...
 String login = "./index.jsp";
    String listar = "./vistas/listarCategorias.jsp";
    String add = "./vistas/agregarCategoria.jsp";
    String edit = "./vistas/editarCategoria.jsp";
        ...
        if (usr == null) {
            ...
            if (action.equalsIgnoreCase("listarCategoria")) {
                ...
                Categoria c = new Categoria();
                 String categoria = request.getParameter("txtNom");
                 c.setCategoria(categoria);
                
                boolean exito = dao.agregar(c);;
                if (exito) {
