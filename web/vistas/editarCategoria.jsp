                ...
                <div class="container-fluid d-flex justify-content-center align-items-center flex-column m-2 py-4">
                    ...
                    <div class="card w-50">
                        ...
                        <%
                            ...
                            Categoria cat = dao.listarId(id);
                        %>

                        <form class="row g-3 mb-3  px-3" action='ControladorCategoria'
                              class='bg-white   p-4 mt-5 rounded ws-80 ws-50 d-flex flex-column justify-content-center align-items-center'
                              method='GET'>
                            <div class="col-md-6">
                                <label for="inputEmail4" class="form-label">Nombre de la categoria</label>
                                <input type="text" class="form-control" name="txtNom"
                                value="<%= cat.getCategoria()%>" required>
                               
                            </div>
                                   <input type="hidden" name="txtid" value="<%= cat.getIdCategoria()%>">
