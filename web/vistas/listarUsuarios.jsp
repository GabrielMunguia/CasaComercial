                        ...
                        <table id="tabla"  class="p-2 mt-5 table table-striped table-bordered  col-12   "  style="width:100%">
                            <thead>
                                <tr class="bg-dark text-white">
                                    ...
                                    <th class="text-center col-4"  >DUI</th>
                            ...
                            <tbody>
                                <%
                                    ...
                                    List<Usuario> list = dao2.listarUsuarios();
                                ...
                                <tr>
                                   ...
                                   <td class="text-center"><%= usuario.getNombre_empleado()%></td>
                                     <td class="text-center"><%= usuario.getDui_empelado()%></td>
                                   <td class="text-center"><%= usuario.getRol()%></td>
                                 
                                   <td class="text-center"><%= usuario.getUsuario()%></td>
                                      <td class="text-center">
                                       
                                       <a class="btn <%= usuario.getEstado()?"btn-success px-4":"btn-danger"%>">   <%= usuario.getEstado()?"Activo":"Inactivo"%></a>
                                      </td>
                                  
                                        <%if (usr.getIdCargo() == 2) { %>
                                    <td class="  container-fluid ">
                                        <a class="btn btn-warning " href="ControladorUsuarios?accion=editar&id=<%= usuario.getID()%>">Editar</a>
                                          <a  class="d-none"  href="ControladorUsuarios?accion=actualizarEstado&id=<%= usuario.getID()%>&estado=<%= !usuario.getEstado()%>">Eliminar</a>
                                        <a class="btn <%= !usuario.getEstado()?"btn-success px-4":"btn-danger"%> btnEliminar"><%= usuario.getEstado()?"Desactivar":"Activar"%></a>
