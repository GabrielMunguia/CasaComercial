        ...
        <section class="home-section bg-white ">
            ...
            <div>
                <div class="container-fluid d-flex justify-content-center align-items-center flex-column  col-12">
                  <h1 class="m-3"> Lista de proveedores</h1>
                        ...
                        <tr>
                           ...
                           <%if(usr.getIdCargo()==1||usr.getIdCargo()==2){ %>
                            <td class="text-center noExport">
                                <a class="btn btn-warning" href="ControladorProveedor?accion=editar&id=<%= p.getIdProveedor()%>">Editar</a>
                       
                                 <%if(usr.getIdCargo()==2){%>
                                    <a  class="d-none" href="ControladorProveedor?accion=eliminar&id=<%= p.getIdProveedor()%>">Eliminar</a>
